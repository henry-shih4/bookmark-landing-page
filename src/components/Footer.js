...
export default function Footer() {
  return (
    <>
      <div className="min-h-[60dvh] h-[60vh] flex flex-col justify-center items-center font-rubik text-white md:min-h-[40dvh] md:h-[40vh]">
        <div className="h-[50%] bg-p-soft-blue flex justify-center items-center w-full md:h-[90%]">
          <div className="w-[90%] flex flex-col gap-y-2 md:w-[25%]">
            ...
            <div className="flex w-full flex-col gap-y-4 mt-4 md:flex-row justify-center items-center md:gap-x-4">
              <input
                placeholder="Enter your email address"
                className="p-2 rounded-md text-[16px] pl-4"
              />
              <button className="p-2 rounded-md bg-p-soft-red text-sm">
                Contact Us
              </button>
            </div>
          </div>
